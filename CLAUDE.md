...
> **Fresh Claude instance? Read [`handoff/2026-07-08-phase1-uipath-3d-visualizer.md`](./handoff/2026-07-08-phase1-uipath-3d-visualizer.md) first** — locked scope, architecture, milestones. This project is **governed by Loom** and is Loom's **Phase-1 proof vehicle**. Loom itself lives in the sibling `loom-template` repo — don't modify it from here; surface upstream fixes via lessons-learned (`upstream: loom-template`) + the Update Bus.
